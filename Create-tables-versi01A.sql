-- In schema Step01A; several constraints are removed
...
CREATE TABLE "Step01A".Categories 
(
  CatOrder integer,
...
CREATE TABLE "Step01A".ClosedCash 
(
  DateEnd timestamp,
...
CREATE TABLE "Step01A".CSVImport 
(
...
CREATE TABLE "Step01A".Customers 
(
  Address varchar(255),
...
CREATE TABLE "Step01A".DrawerOpened 
(
  Id varchar(255) NOT NULL,
  Name varchar(255),
...
CREATE TABLE "Step01A".LineRemoved 
(
  Id varchar(255) NOT NULL,
  Name varchar(255),
...
CREATE TABLE "Step01A".Locations 
(
  Address varchar(255),
  Id varchar(255) NOT NULL,
  Name varchar(255), -- NOT NULL
...
CREATE TABLE "Step01A".Merchants 
(
...
CREATE TABLE "Step01A".Products_com 
(
  Id varchar(255) NOT NULL,
...
CREATE TABLE "Step01A".Products_kit 
(
  Id varchar(255) NOT NULL,
  Product varchar(255) NOT NULL,
...
CREATE TABLE "Step01A".Promotions 
(
  AllProducts boolean DEFAULT false, -- boolean
  Criteria ByteA,
  Id varchar(50) NOT NULL,
...
CREATE TABLE "Step01A".Shift_Breaks 
(
...
CREATE TABLE "Step01A".StockChanges 
(
  BLObValue ByteA,
...
CREATE TABLE "Step01A".StockCurrent 
(
...
CREATE TABLE "Step01A".StockDiary 
(
  AppUser varchar(255),
  AttributeSetInstance_Id varchar(255),
  DateNew timestamp NOT NULL,
...
CREATE TABLE "Step01A".StockLevel 
(
  Id varchar(255) NOT NULL,
  Location varchar(255) NOT NULL,
  Product varchar(255) NOT NULL,
...
CREATE TABLE "Step01A".TaxCategories 
(
  Id varchar(255) NOT NULL,
  Name varchar(255), -- NOT NULL
  SFlag boolean DEFAULT true, -- boolean
...
CREATE TABLE "Step01A".ThirdParties 
(
  Address varchar(255),
...
CREATE TABLE "Step01A".TicketLines 
(
  Attributes ByteA,
  AttributeSetInstance_Id varchar(255),
