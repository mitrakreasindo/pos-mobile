...
public class Command {
  ...
  //打印自检页 Mencetak halaman uji diri
  ...
  //设置下划线点高度(汉字) tinggi set point bawah (Kanji)
  ...
  //标准弹钱箱指令 perintah cashbox standar rudal
